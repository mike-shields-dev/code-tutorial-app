/**
 * @description Asserts that the provided object conforms to the ITutorial interface.
 * @param obj - The object to check.
 * @returns boolean - Returns true if the object matches the ITutorial shape; otherwise, false.
 */

export default function isTutorial(obj: any): obj is ITutorial {
  return (
